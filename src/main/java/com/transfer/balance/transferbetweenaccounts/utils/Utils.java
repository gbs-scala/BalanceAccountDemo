package com.transfer.balance.transferbetweenaccounts.utils;
    ...
    public static void loadConfig(String fileName) {
        if (fileName == null) {
            ...
            try {
                ...
                log.error("file name not found " + fileName, fne);
            } catch (IOException ioe) {
                log.error("error when reading the config " + fileName, ioe);
            }
        }
